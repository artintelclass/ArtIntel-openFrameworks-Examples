...
void ofApp::update(){
    ...
    if (sendScreen) {
        ...
        ofxOpenNIJoint & joint = user.getJoint((Joint) JOINT_RIGHT_HAND);
...
void ofApp::draw(){
    ...
    ofDrawBitmapStringHighlight(oscMessageString, 15, ofGetHeight() - 20);
}
